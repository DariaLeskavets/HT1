...
public class ManagePersonServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
        ...
        RequestDispatcher dispatcher_for_editorPerson = request.getRequestDispatcher("/EditorPerson.jsp");
        RequestDispatcher dispatcher_for_editorPhone = request.getRequestDispatcher("/EditorPhone.jsp");
        ...
        else
        {
        	switch (action)
        	{
        		...
        		case "back":
        			...
        			jsp_parameters.put("current_action", "edit");
        			jsp_parameters.put("next_action", "edit_go");
        			jsp_parameters.put("next_action_label", "Вернуться к списку");
        		...
        		case "editPhone":
        			...
        			// Передача запроса в JSP.
        			dispatcher_for_editorPhone.forward(request, response);
        		break;
